...
import { BridgeRegistry, type BridgeSourceInput, type BridgeAdoptionAck } from './bridge-registry.ts'
...
export async function openOwnerPiBridge(runner: WorkbenchRunner, socketPath: string, options: { now?: () => number; onInput?: (event: BridgeSourceInput) => void; onAdoptionAck?: (event: BridgeAdoptionAck) => void } = {}) {
