...
Control {
    ...
    readonly property var selectedGoal: {
        if (root.projection && root.projection.selectedGoal !== undefined) return root.projection.selectedGoal
    ...
    readonly property var selectedProject: {
        if (root.projection && root.projection.selectedProject !== undefined) return root.projection.selectedProject
