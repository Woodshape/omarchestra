 ...
 * defaults. Version 0.7.0 is the task-first redesign; the exact pre-redesign
 * 0.6.0 bytes are retained separately in `retained/0.6.0/` and are never part
 * of the active production catalogue.
 */

export const WORKBENCH_PLUGIN_ID = 'omarchestra.agent-console'
export const WORKBENCH_PLUGIN_VERSION = '0.7.0'
