 ...
 *
 * This package contains only its own active release (0.12.0). It does not copy
 ...
 * assets, then the exact installed 0.10.0 and 0.11.0 assets, were retained before publishing 0.12.0.
 */
