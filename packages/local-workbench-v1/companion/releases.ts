...
export const WORKBENCH_RELEASE: WorkbenchRelease = freezeWorkbenchRelease({
  ...
  assets: {
    ...
    'WorkbenchWake.qml': readQml('WorkbenchWake.qml'),
    'workbench-wake.mjs': readQml('workbench-wake.mjs'),
    'WorkbenchRows.qml': readQml('WorkbenchRows.qml'),
    'SessionText.js': readQml('SessionText.js'),
