...
Status: **S1–S6 disposable engineering checkpoints PASS; bounded independent integration review completed without remaining blocking findings; overall Phase 2 remains INCOMPLETE: the operator-authorized [live setup and native open](../reviews/local-workbench-phase-2-verification/live-setup-and-open.md) now pass, but native management actions and exact confirmed Adoption are pending. The historical [preflight](../reviews/local-workbench-phase-2-verification/human-walkthrough-preflight.md) pin was replaced by capability-based gating ([ADR 0005](../adr/0005-negotiate-companion-features-not-host-package-versions.md)).** The [first persistence checkpoint](../reviews/local-workbench-phase-2-verification/persistence-checkpoint.md) repairs owned-resource substitution and backup/schema validation. The [binding/fence checkpoint](../reviews/local-workbench-phase-2-verification/binding-fence-checkpoint.md) adds exact identity/membership storage and interruption-safe minimal retention. Direct implementation and source self-review only, not independent agent review. S2's injected command/source path is now covered: the [database-owned command checkpoint](../reviews/local-workbench-phase-2-verification/command-transactions-checkpoint.md) and [management-outcome checkpoint](../reviews/local-workbench-phase-2-verification/management-outcomes-checkpoint.md) pass. Retirement/purge now reconcile durable authorization and receipts across the ledger; request-Adoption and Take control are transactional. The [source/outcome checkpoint](../reviews/local-workbench-phase-2-verification/source-outcomes-checkpoint.md) now covers snapshot-before-feedback, read-only outcome queries, heartbeat and source close/reconnect. The [delivery-outbox checkpoint](../reviews/local-workbench-phase-2-verification/delivery-outbox-checkpoint.md) now commits authorization/binding delivery intent before any send and retains uncertain attempts without automatic replay. The [authority-envelope checkpoint](../reviews/local-workbench-phase-2-verification/intent-envelope-checkpoint.md) closes bounded full-envelope/target validation and original-envelope receipt/query identity. The [S3 Project-context checkpoint](../reviews/local-workbench-phase-2-verification/project-context-checkpoint.md) now passes: unavailable Git facts, same-path replacement, startup/operation revalidation and explicit transactional reconfirmation. The [S3 check-resource checkpoint](../reviews/local-workbench-phase-2-verification/check-resources-checkpoint.md) now resolves executable, exact cwd and declared resources at save, persists immutable versioned canonical bytes/digests and tests composed QML creation/editing with zero execution. Schema 8 refused earlier unchecked schema-7 roots without migration; S5 now uses schema **9**, refusing schema-8 development roots without an explicit supported upgrade. S3 is engineering-complete subject to independent review; challenged delivery reconciliation requires the S4 real bridge. The [S4 framed Pi bridge checkpoint](../reviews/local-workbench-phase-2-verification/real-pi-bridge-checkpoint.md) tests an owner-only socket and fake Pi host. The [S5 framed Adoption checkpoint](../reviews/local-workbench-phase-2-verification/framed-adoption-checkpoint.md) now tests the exact challenged management path through a disposable same-Pi bridge, Goal-scoped membership and restart/purge. The [S6 native/composed checkpoint](../reviews/local-workbench-phase-2-verification/native-owner-composition-checkpoint.md) now composes it into the native owner and presentation entry; live management acceptance remains unrun.

A subsequent user-directed [Adoption exchange guard checkpoint](../reviews/local-workbench-phase-2-verification/adoption-exchange-checkpoint.md) repairs deadline and subscription-lifetime checks in the existing manager. This is a bounded F4/connection-guard repair, not full S5 integration or satisfaction of the S2/S4 prerequisites. S2 was subsequently completed as a prerequisite for full Adoption integration.
...
The milestone remains: register a Project, persist Goals/checks, adopt an exact visible Pi and reopen the native workbench without losing history. All engineering gates are disposable/offscreen/provider-free. Real Assignment delivery and check execution remain prohibited. No Board, Plannotator, remote execution, broad global installation or broad visual redesign. Exception approved after the live walkthrough: one bounded, explicitly enabled local systemd user-service lifecycle for the already-implemented owner. The earlier foreground-only S6 gate remains historical; the service is not an agent/PTY supervisor, may not start Pi, and must not change any Team Goal execution rule.
...
**S3 checkpoint: engineering PASS (Project context plus check resolution); see the later bounded independent integration review and current S6 status above.** Schema 8 retains observed directory identity from schema 7 and changes persisted check definitions to runner-resolved pinned bytes. Failed probes never project clean; external filters are refused before status, nested submodule configurations are bounded/preflighted without dropping safe parent support, and lazy fetch/transports are disabled. Explicit reconfirmation crosses the actual offscreen QML/adapter/runner path and preserves history/uncertainty. [Evidence and limits](../reviews/local-workbench-phase-2-verification/project-context-checkpoint.md). C14 save-time resource resolution is now covered by the [second S3 checkpoint](../reviews/local-workbench-phase-2-verification/check-resources-checkpoint.md); S5 Run-context composition and C7/C9 execution-time resource/candidate validation remain separate.
...
**Checkpoint:** real persistent Project/Goal/check configuration, including versioned resolved resources, ready for S4/S5 composition; no execution or independent acceptance claim.

## S4 — Real content-free bridge and connection registry

**Current checkpoint: S4 engineering PASS:** production-intended Pi extension entry, owner-only framed Unix-socket listener and connection registry are fake-host/real-socket tested. [Evidence and boundaries](../reviews/local-workbench-phase-2-verification/real-pi-bridge-checkpoint.md). This S4-only checkpoint does not claim live Pi installation or bridge→management conversion; S5 subsequently completed challenged Adoption/binding/readiness, and S6 subsequently started the listener from the native owner entry. The later bounded independent integration review is recorded above.
...
**S5 checkpoint: engineering PASS; the later bounded independent integration review is recorded above.** The [framed Adoption checkpoint](../reviews/local-workbench-phase-2-verification/framed-adoption-checkpoint.md) connects operator intent, exact challenged ACK, transactional membership/delivery, receipt/readiness, recovery, takeover, retirement and purge through a disposable fake Pi. The earlier [ACK-only seam](../reviews/local-workbench-phase-2-verification/challenged-ack-seam-progress.md) alone did not do this. S5 is not native-entry or complete Phase-2 acceptance.
...
**Current checkpoint: S6 engineering PASS, [independent integration review](../reviews/local-workbench-phase-2-verification/independent-integration-review.md) complete without remaining blocking findings, human walkthrough in progress: live setup, loaded negotiation and stable native dock passed; Project/Goal actions and exact confirmed Adoption remain pending.** The [native owner/composition checkpoint](../reviews/local-workbench-phase-2-verification/native-owner-composition-checkpoint.md) records the passing disposable full Phase-2 engineering gate, Phase-1/prototype regressions and the separate human authorization boundary. No live Pi/Companion installation or management acceptance was attempted.
