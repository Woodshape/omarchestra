...
**Current checkpoint: S4 engineering PASS:** production-intended Pi extension entry, owner-only framed Unix-socket listener and connection registry are fake-host/real-socket tested. [Evidence and boundaries](../reviews/local-workbench-phase-2-verification/real-pi-bridge-checkpoint.md). No live Pi installation or bridge→management conversion is claimed; S5 owns challenged Adoption, binding delivery and exact readiness, S6 owns starting the listener from the native owner entry. Independent review pending.
...
**Current checkpoint: S5 engineering PASS (independent overall review pending).** The [framed Adoption checkpoint](../reviews/local-workbench-phase-2-verification/framed-adoption-checkpoint.md) connects operator intent, exact challenged ACK, transactional membership/delivery, receipt/readiness, recovery, takeover, retirement and purge through a disposable fake Pi. The earlier [ACK-only seam](../reviews/local-workbench-phase-2-verification/challenged-ack-seam-progress.md) alone did not do this. S5 is not native-entry or complete Phase-2 acceptance.
