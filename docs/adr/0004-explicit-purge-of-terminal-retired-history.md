...
records, presentation card, and associated retirement/Adoption events. It
does not delete or modify Pi conversations, session files, processes, tools,
checkouts, artifacts, or any external resource. Purge is never automatic and
...
- Durable stores need a purge transaction and a persistent vacancy
  high-water mark.
